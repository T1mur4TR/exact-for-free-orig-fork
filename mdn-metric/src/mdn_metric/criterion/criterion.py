...
class Criterion(torch.nn.Module):
    ...
    def get_default_config(use_softmax=True, logits_batchnorm=False, xent_weight=1.0, xent_smoothing=0.0,
                           ...
                           gex_weight=0.0, gex_margin=None, gex_cap=None, gex_smoothing=None, gex_use_k_closest=None,
    ...
    def __init__(self, *, config=None):
        ...
        if self._config["gex_weight"] > 0:
            self._gex = GEX(batch_norm=False, margin=self._config["gex_margin"], cap=self._config["gex_cap"], label_smoothing=self._config["gex_smoothing"], use_k_closest=self._config["gex_use_k_closest"])
